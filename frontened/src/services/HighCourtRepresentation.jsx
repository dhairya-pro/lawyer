...
import { FaGavel, FaHandshake, FaBalanceScale, FaMapMarkedAlt, FaChartLine, FaQuestionCircle, FaPhoneAlt, FaWhatsapp, FaEnvelope } from 'react-icons/fa';
import { FaGlobe, FaRegPaperPlane } from 'react-icons/fa';
import ServiceContactForm from '../components/ServiceContactForm';
const HighCourtRepresentation = () => {
    ...
    const practiceAreas = [
        {
            ...
            items: [
                'Article 226 and 227 petitions',
                'Challenging government and administrative actions',
        ...
        },
        {
            ...
            items: [
                ...
                'Revisions and review petitions',
        ...
        },
        {
            ...
            items: [
                'Bail applications in serious offenses',
        ...
        },
        {
            ...
            items: [
                ...
                'Discharge applications in criminal cases',
            ],
        },
        {
            title: 'Service & Employment Matters',
            items: [
                'Service disputes and disciplinary actions',
                'Government job and recruitment cases',
            ],
        },
        {
    ...
    const reasonsToChoose = [
        'Extensive experience in Gujarat High Court practice',
        'Strategic approach to complex writs and appeals',
        'Strong oral and written advocacy',
        'Timely updates and transparent communication',
        'Client-focused, ethical representation',
    ...
    const processSteps = [
        ...
        'Drafting and filing petition/appeal',
        'Court hearings and arguments',
        'Order, follow-up, and compliance',
    ];

    const faqs = [
        {
            question: 'What is a writ petition?',
            answer: 'A writ petition is filed in High Court to enforce fundamental rights or challenge illegal actions of authorities under Articles 226/227 of the Constitution.'
        },
        {
            question: 'Can I appeal a lower court order in High Court?',
            answer: 'Yes, most civil and criminal orders can be appealed or revised in the High Court, subject to legal grounds.'
        },
        {
            question: 'How long does a High Court case take?',
            answer: 'It depends on the complexity and urgency, but we strive for efficient and timely resolution.'
        },
    ];
        ...
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="relative flex items-center justify-center overflow-hidden pt-32 sm:pt-44 md:pt-40 min-h-[100vh]">
                <div 
                    ...
                    style={{ 
                        backgroundImage: "url('https://images.unsplash.com/photo-1589829545856-d10d557cf95f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80')",
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaGavel className="mr-2" /> High Court Expertise
                            </span>
                        </div>
                        <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-white mb-8 leading-tight">
                            High Court <br/>
                            <span className="text-[#C85E4D]">Representation in Gujarat</span>
                        </h1>
                        <p className="text-base sm:text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Expert legal representation in the Gujarat High Court – protecting your rights with strategic advocacy.
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-gray-800">
                            High Court matters need <span className="text-[#C85E4D]">expert legal representation.</span>
                        </h2>
                        <p className="text-base sm:text-xl text-gray-600 leading-relaxed">
                            Our experienced team provides comprehensive legal representation in the Gujarat High Court, ensuring your rights are protected with strategic advocacy.
                        </p>
                        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Expert Advocacy</h3>
                                <p className="text-gray-600">We provide strong legal representation.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                ...
                                <p className="text-gray-600">We fight for your rights in court.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaGavel className="mr-2" /> Our High Court Services
                            </span>
                        </div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Practice Areas in High Court</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Comprehensive legal support for this aspect of high court representation.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A]">Why Choose Our High Court Team?</h2>
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your case deserves expert legal representation.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to your case's success, every step of the way.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-[#F9FAFB]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">We handle high court cases in all major cities and districts.</p>
                    </motion.div>
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Remote legal support available for high court cases in Gujarat.</p>
...
export default HighCourtRepresentation; 