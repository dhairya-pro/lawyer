...
import { FaShieldAlt, FaBalanceScale, FaGavel, FaMapMarkedAlt, FaChartLine, FaQuestionCircle, FaPhoneAlt, FaWhatsapp, FaEnvelope } from 'react-icons/fa';
...
const CyberLaw = () => {
    ...
    const faqs = [
        {
            question: "What types of cyber crimes do you handle?",
            answer: "We handle various cyber crimes including online fraud, data breaches, identity theft, cyber harassment, and digital privacy violations."
        },
        {
            question: "How quickly can you respond to a cyber crime incident?",
            answer: "We provide 24/7 emergency response for cyber crime incidents, with immediate digital forensics support and legal guidance."
        },
        {
            question: "Do you offer preventive legal services for businesses?",
            answer: "Yes, we provide comprehensive preventive services including privacy policy drafting, compliance audits, and employee training programs."
        }
    ];
        ...
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                <div 
                    ...
                    style={{ 
                        backgroundImage: "url('https://images.unsplash.com/photo-1550751827-4bd374c3f58b?auto=format&fit=crop&w=1500&q=80')",
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaShieldAlt className="mr-2" /> Cyber Law & Digital Rights
                            </span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-8 leading-tight">
                            Cyber Law <br/>
                            <span className="text-[#C85E4D]">Digital Protection & Rights</span>
                        </h1>
                        <p className="text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Expert legal solutions for cyber crimes, digital privacy, and online business protection across Gujarat
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-4xl font-bold mb-8 text-gray-800">
                            Digital threats or cyber crime? <span className="text-[#C85E4D]">Get expert legal protection.</span>
                        </h2>
                        <p className="text-xl text-gray-600 leading-relaxed">
                            From cyber crime defense to digital privacy protection, we provide comprehensive legal solutions for all your digital legal needs.
                        </p>
                        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            >
                                <div className="w-16 h-16 bg-[#E6D8B8] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaShieldAlt className="text-[#C85E4D] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Cyber Crime Defense</h3>
                                <p className="text-gray-600">Expert defense against online fraud and cyber crimes.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Digital Privacy</h3>
                                <p className="text-gray-600">Comprehensive privacy protection and compliance.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">E-Commerce Law</h3>
                                <p className="text-gray-600">Legal support for online businesses.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaShieldAlt className="mr-2" /> Our Services
                            </span>
                        </div>
                        <h2 className="text-4xl font-bold text-gray-800">Cyber Law Services</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Expert legal support for cyber law matters.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl font-bold text-[#1E3A8A]">Why Choose Our Cyber Law Team?</h2>
                        <p className="mt-4 text-lg text-gray-600">Your digital rights deserve expert protection.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to protecting your digital rights and interests.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Remote legal consultation available for cyber law matters in Gujarat.</p>
