...
import { FaGavel, FaShieldAlt, FaUserShield, FaBalanceScale, FaMapMarkedAlt, FaChartLine, FaQuestionCircle, FaPhoneAlt, FaWhatsapp, FaEnvelope } from 'react-icons/fa';
...
const CriminalDefense = () => {
    ...
    // Unique practice areas for Criminal Defense
    const practiceAreas = [
        {
            title: 'Bail & Anticipatory Bail',
            items: [
                'Regular bail applications',
                'Anticipatory bail for pre-arrest protection',
                'Bail hearings in Sessions & High Court',
            ],
        },
        {
            title: 'Trial Defense',
            items: [
                ...
                'Legal arguments and final submissions',
            ],
        },
        {
            title: 'Quashing & Discharge',
            items: [
                'Quashing of FIRs and criminal complaints',
                'Discharge applications at pre-trial stage',
            ],
        },
        {
            ...
            items: [
                ...
                'Revisions in Sessions or High Court',
            ],
        },
        {
            title: 'Criminal Complaints & FIRs',
            items: [
                'Drafting and filing criminal complaints',
                'FIR registration and follow-up',
            ],
        },
        {
            title: 'White Collar Crimes',
            items: [
                'Fraud, forgery, and cheating cases',
                'Cybercrime defense',
            ],
        },
    ];
    ...
    const reasonsToChoose = [
        'Proven track record in criminal courts across Gujarat',
        'Strategic defense for complex and high-profile cases',
        '24/7 support for urgent bail and arrest matters',
        'Transparent communication and regular updates',
        'Strong negotiation skills for settlements and plea bargains',
        'Multilingual advocacy: Gujarati, Hindi, and English',
    ];
    ...
    const processSteps = [
        'Contact us immediately for urgent legal help.',
        'Share FIR, charge sheet, or case documents.',
        'We analyze your case and plan a defense strategy.',
        'Representation in court and regular case updates.',
    ];

    const faqs = [
        {
            question: 'What should I do if I am arrested?',
            answer: 'Stay calm, do not resist, and contact your lawyer immediately. You have the right to remain silent and to legal representation.',
        },
        {
            question: 'Can I get bail in a serious criminal case?',
            answer: 'Bail is possible in many cases, depending on the facts and the stage of the case. We specialize in urgent bail applications.',
        },
        {
            question: 'How long does a criminal trial take?',
            answer: 'It varies by case complexity, but we work to expedite hearings and minimize delays.',
        },
    ];
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaGavel className="mr-2" /> Criminal Defense Expertise
                            </span>
                        </div>
                        ...
                        <p className="text-base sm:text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Aggressive and strategic defense for all criminal matters – from bail to acquittal, we protect your rights at every stage.
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-gray-800">
                            Accused or under investigation? <span className="text-[#C85E4D]">Protect your rights with expert defense.</span>
                        </h2>
                        <p className="text-base sm:text-xl text-gray-600 leading-relaxed">
                            Criminal charges can threaten your freedom and reputation. Our experienced defense team provides aggressive representation, from bail to acquittal, ensuring your side is heard at every stage.
                        </p>
                        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            >
                                <div className="w-16 h-16 bg-[#E6D8B8] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaGavel className="text-[#C85E4D] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Aggressive Defense</h3>
                                <p className="text-gray-600">We fight for your rights at every stage of the criminal process.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Bail & Urgent Relief</h3>
                                <p className="text-gray-600">Fast action for bail and anticipatory bail in urgent situations.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                <div className="w-16 h-16 bg-[#E6D8B8] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaUserShield className="text-[#C85E4D] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Strategic Case Planning</h3>
                                <p className="text-gray-600">Every case is unique. We build a custom defense for your situation.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaShieldAlt className="mr-2" /> Our Criminal Defense Services
                            </span>
                        </div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Practice Areas in Criminal Law</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Detailed defense for this aspect of criminal law.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A]">Why Choose Our Criminal Defense Team?</h2>
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your freedom and reputation deserve the best defense.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to your defense, every step of the way.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-[#F9FAFB]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">We defend clients in all major cities and districts.</p>
                    </motion.div>
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Remote legal defense and consultation available for criminal cases in Gujarat.</p>
