...
import { FaHeart, FaBalanceScale, FaGavel, FaMapMarkedAlt, FaChartLine, FaQuestionCircle, FaPhoneAlt, FaWhatsapp, FaEnvelope } from 'react-icons/fa';
import { FaGlobe, FaHandshake, FaRegPaperPlane } from 'react-icons/fa';
import ServiceContactForm from '../components/ServiceContactForm';
const CourtMarriageRegistration = () => {
    ...
    const processSteps = [
        ...
        "Court proceedings & registration",
    ...
    const faqs = [
        {
            ...
            answer: "Required documents include age proof, address proof, passport size photographs, and affidavits. We guide you through the complete documentation process."
        },
        {
            question: "How long does court marriage registration take?",
            answer: "The process typically takes 30-60 days, depending on document verification and court availability. We ensure the quickest possible completion."
        },
        {
            question: "Do you handle inter-religious marriages?",
            answer: "Yes, we specialize in handling inter-religious marriages and ensure all legal requirements are met for a smooth registration process."
        }
    ];
        ...
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                <div 
                    ...
                    style={{ 
                        backgroundImage: "url('https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&w=1500&q=80')",
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaHeart className="mr-2" /> Court Marriage
                            </span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-8 leading-tight">
                            Court Marriage <br/>
                            <span className="text-[#C85E4D]">Registration & Legal Support</span>
                        </h1>
                        <p className="text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Expert legal support for court marriage registration and documentation across Gujarat
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-4xl font-bold mb-8 text-gray-800">
                            Marriage registration? <span className="text-[#C85E4D]">Get expert legal support.</span>
                        </h2>
                        <p className="text-xl text-gray-600 leading-relaxed">
                            From documentation to court proceedings, we provide comprehensive support for your court marriage registration.
                        </p>
                        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Court Marriage</h3>
                                <p className="text-gray-600">Expert guidance on registration.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                ...
                                <p className="text-gray-600">Comprehensive document support.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                ...
                                <p className="text-gray-600">Expert legal guidance.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaHeart className="mr-2" /> Our Services
                            </span>
                        </div>
                        <h2 className="text-4xl font-bold text-gray-800">Marriage Registration Services</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Expert support for marriage registration.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl font-bold text-[#1E3A8A]">Why Choose Our Marriage Law Team?</h2>
                        <p className="mt-4 text-lg text-gray-600">Your marriage registration deserves expert handling.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to making your marriage registration smooth and hassle-free.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Remote legal consultation available for marriage registration in Gujarat.</p>
...
export default CourtMarriageRegistration; 