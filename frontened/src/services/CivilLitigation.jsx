...
const CivilLitigation = () => {
    ...
    return (
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Practice Areas Covered Under Civil Litigation</h2>
                    </motion.div>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your trusted partner in navigating civil litigation with confidence.</p>
                    </motion.div>
            ...
            <ServiceContactForm 
                title="Let's Talk"
                subtitle="Need help with civil litigation? Contact us for expert legal representation and support."
            />
        </div>
    );
};
