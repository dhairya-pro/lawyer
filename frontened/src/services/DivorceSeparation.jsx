...
import { FaHeartBroken, FaHandshake, FaBalanceScale, FaMapMarkedAlt, FaChartLine, FaQuestionCircle, FaPhoneAlt, FaWhatsapp, FaEnvelope } from 'react-icons/fa';
import { FaGlobe, FaHandshake as FaHandshakeIcon, FaRegPaperPlane } from 'react-icons/fa';
import ServiceContactForm from '../components/ServiceContactForm';
const DivorceSeparation = () => {
    ...
    const reasonsToChoose = [
        "Compassionate & Confidential Handling",
        "Expertise in Family & Divorce Laws",
        "Strong Negotiation & Litigation Skills",
    ...
    const processSteps = [
        ...
        "Filing, negotiation, or litigation",
        "Resolution & post-divorce support"
    ];

    const faqs = [
        {
            question: "How long does a mutual consent divorce take?",
            answer: "A mutual consent divorce can be finalized in 6-8 months, subject to statutory waiting periods and court schedules."
        },
        {
            question: "Can I get custody of my child?",
            answer: "Custody decisions are based on the child's best interests. We help you present a strong case for custody or visitation."
        },
        {
            question: "What is the difference between divorce and judicial separation?",
            answer: "Divorce dissolves the marriage, while judicial separation allows spouses to live apart without ending the marriage."
        }
    ];
        ...
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="relative flex items-center justify-center overflow-hidden pt-32 sm:pt-44 md:pt-40 min-h-[100vh]">
                <div 
                    ...
                    style={{ 
                        backgroundImage: "url('https://myfitbrain.in/images/blogs/reasons-why-divorce-happens_1720618689.jpg')",
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaHeartBroken className="mr-2" /> Divorce & Separation Expertise
                            </span>
                        </div>
                        ...
                        <p className="text-base sm:text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Compassionate legal guidance through divorce and separation – protecting your rights while minimizing emotional stress.
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-gray-800">
                            Going through a divorce? <span className="text-[#C85E4D]">Let us guide you with compassion and expertise.</span>
                        </h2>
                        <p className="text-base sm:text-xl text-gray-600 leading-relaxed">
                            Divorce and separation can be emotionally challenging. Our experienced team provides compassionate legal guidance while protecting your rights and interests.
                        </p>
                        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            >
                                <div className="w-16 h-16 bg-[#E6D8B8] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaHeartBroken className="text-[#C85E4D] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Compassionate Support</h3>
                                <p className="text-gray-600">We understand the emotional challenges of divorce.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Amicable Solutions</h3>
                                <p className="text-gray-600">We prefer peaceful settlements when possible.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Strong Advocacy</h3>
                                <p className="text-gray-600">We fight for your rights when needed.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaHeartBroken className="mr-2" /> Our Divorce & Separation Services
                            </span>
                        </div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Practice Areas in Family Law</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Comprehensive legal support for this aspect of family law.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A]">Why Choose Our Divorce & Separation Team?</h2>
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your emotional well-being deserves expert legal support.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to your emotional and legal well-being, every step of the way.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-[#F9FAFB]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">We handle divorce and separation cases in all major cities and districts.</p>
                    </motion.div>
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Remote legal support available for divorce cases in Gujarat.</p>
