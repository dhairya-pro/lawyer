...
import { FaUnlockAlt, FaBalanceScale, FaGavel, FaMapMarkedAlt, FaChartLine, FaQuestionCircle, FaPhoneAlt, FaWhatsapp, FaEnvelope, FaGlobe, FaHandshake, FaRegPaperPlane } from 'react-icons/fa';
import ServiceContactForm from '../components/ServiceContactForm';

const BailAnticipatoryBail = () => {
    ...
    const practiceAreas = [
        {
            ...
            items: [
                ...
                "Bail after arrest",
                "Bail bond and surety procedures"
            ]
        },
        {
        ...
        {
            title: "Bail Cancellation & Modification",
            items: [
                "Cancellation of bail",
                "Modification of bail conditions",
                "Opposing bail applications",
                "Enforcement of bail orders"
            ]
        },
        {
            title: "Special Bail Matters",
            items: [
                "Juvenile bail",
                "Bail in economic offences",
                "Bail in NDPS & POCSO cases",
                "Bail in white-collar crimes"
            ]
        }
    ];

    const reasonsToChoose = [
        "Quick & Strategic Bail Applications",
        "Expertise in Criminal Law & Procedure",
        "Strong Representation in Courts",
    ...
    const processSteps = [
        ...
        "Drafting & filing bail application",
        "Court hearing & arguments",
        "Order, release, or further legal action"
    ];

    const faqs = [
        {
            question: "What is the difference between regular bail and anticipatory bail?",
            answer: "Regular bail is sought after arrest, while anticipatory bail is pre-arrest protection from arrest in anticipation of being accused."
        },
        {
            question: "Can bail be denied?",
            answer: "Yes, bail can be denied based on the gravity of the offence, risk of absconding, or tampering with evidence. We help present a strong case for bail."
        },
        {
            question: "How quickly can bail be obtained?",
            answer: "Bail can often be obtained within a few days, depending on the court's schedule and case complexity. We prioritize urgent bail matters."
        }
    ];
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaUnlockAlt className="mr-2" /> Bail & Anticipatory Bail
                            </span>
                        </div>
                        <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-white mb-8 leading-tight">
                            Bail & Anticipatory Bail <br/>
                            <span className="text-[#C85E4D]">Legal Services</span>
                        </h1>
                        <p className="text-base sm:text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Fast, strategic, and expert legal support for bail and anticipatory bail matters across Gujarat
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-gray-800">
                            Your <span className="text-[#C85E4D]">Freedom & Rights</span> Protected
                        </h2>
                        <p className="text-base sm:text-xl text-gray-600 leading-relaxed">
                            We guide you through every step of the bail or anticipatory bail process, ensuring your rights and liberty are protected.
                        </p>
                        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            >
                                <div className="w-16 h-16 bg-[#E6D8B8] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaUnlockAlt className="text-[#C85E4D] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Regular Bail</h3>
                                <p className="text-gray-600">Securing release after arrest in criminal cases.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Anticipatory Bail</h3>
                                <p className="text-gray-600">Pre-arrest protection from detention.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Bail Hearings</h3>
                                <p className="text-gray-600">Strong representation in bail hearings and appeals.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaUnlockAlt className="mr-2" /> Our Services
                            </span>
                        </div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Bail & Anticipatory Bail Services</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Expert legal support for bail matters.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A]">Why Choose Us for Bail & Anticipatory Bail?</h2>
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your trusted partner for all criminal law needs.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We ensure your bail matters are handled with expertise and urgency.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-[#F9FAFB]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">We handle bail & anticipatory bail cases across all major cities and districts in Gujarat.</p>
                    </motion.div>
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    <h3 className="text-xl font-bold text-gray-800">Online Bail Support</h3>
                                    <p className="text-gray-700 mb-4">Comprehensive legal support for bail matters across Gujarat.</p>
...
export default BailAnticipatoryBail; 