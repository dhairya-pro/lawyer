...
const PropertyLaw = () => {
    ...
    const practiceAreas = [
        {
            ...
            items: [
                ...
                'Title disputes and encroachment cases',
                'Illegal possession and trespassing',
                'Property mutation and record corrections',
            ],
        },
        {
    ...
    const reasonsToChoose = [
        'Expertise in Gujarat property laws and regulations',
        'Comprehensive property title verification',
        'Strong track record in property dispute resolution',
        'Efficient documentation and registration process',
    ...
    const processSteps = [
        ...
        'Document verification and title search',
    ...
    const faqs = [
        {
            ...
            answer: 'The duration varies based on case complexity, but we ensure efficient handling and regular updates throughout the process.'
        },
        {
            question: 'What documents are needed for property verification?',
            answer: 'We typically need property documents, title deeds, tax receipts, and any relevant agreements. We can guide you on specific requirements.'
        },
        {
            question: 'Can NRIs handle property matters remotely?',
            answer: 'Yes, we provide comprehensive remote support for NRIs, including document handling, power of attorney, and regular updates.'
        },
    ];
    ...
    return (
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-gray-800">
                            Your property matters need <span className="text-[#C85E4D]">expert guidance.</span>
                        </h2>
                        <p className="text-base sm:text-xl text-gray-600 leading-relaxed">
                            Our experienced team provides comprehensive property law services, ensuring your interests are protected.
                        </p>
                        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Legal Guidance</h3>
                                <p className="text-gray-600">We provide expert property law advice.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                <div className="w-16 h-16 bg-[#F5F5F0] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaHandshakeIcon className="text-[#1E3A8A] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Strategic Solutions</h3>
                                <p className="text-gray-600">We develop effective property strategies.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                ...
                                <p className="text-gray-600">We protect your property interests.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaGavel className="mr-2" /> Our Property Law Services
                            </span>
                        </div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Practice Areas in Property Law</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Comprehensive legal support for this property area.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A]">Why Choose Our Property Law Team?</h2>
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your property matters deserve expert guidance.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to protecting your property interests, every step of the way.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-[#F9FAFB]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">We provide property law services in all major cities and districts.</p>
                    </motion.div>
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Remote property law services available for clients in Gujarat.</p>
            ...
            <ServiceContactForm 
                title="Let's Talk"
                subtitle="Need help with property law matters? Contact us for expert legal guidance and support."
            />
        </div>
    );
};
