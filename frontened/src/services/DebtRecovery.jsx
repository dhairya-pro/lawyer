...
import { FaMoneyBillWave, FaHandshake, FaChartLine, FaMapMarkedAlt, FaQuestionCircle, FaPhoneAlt, FaWhatsapp, FaEnvelope } from 'react-icons/fa';
...
const DebtRecovery = () => {
    ...
    const faqs = [
        {
            question: "What is the typical timeline for debt recovery?",
            answer: "The timeline varies based on case complexity, but we aim for quick resolution through strategic legal action and negotiation."
        },
        {
            question: "What documents are needed for debt recovery?",
            answer: "Required documents include loan agreements, promissory notes, invoices, and any communication related to the debt. We guide you through the documentation process."
        },
        {
            question: "Can you help with out-of-court settlements?",
            answer: "Yes, we specialize in both court proceedings and out-of-court settlements, always aiming for the most efficient resolution for our clients."
        }
    ];
        ...
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="relative flex items-center justify-center overflow-hidden pt-32 sm:pt-44 md:pt-40 min-h-[100vh]">
                <div 
                    ...
                    style={{ 
                        backgroundImage: "url('https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80')",
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaMoneyBillWave className="mr-2" /> Debt Recovery Expertise
                            </span>
                        </div>
                        ...
                        <p className="text-base sm:text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Strategic debt recovery solutions for businesses and individuals – from negotiation to legal action, we help you recover what's rightfully yours.
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-gray-800">
                            Struggling with unpaid debts? <span className="text-[#C85E4D]">Let us help you recover what's yours.</span>
                        </h2>
                        <p className="text-base sm:text-xl text-gray-600 leading-relaxed">
                            Unpaid debts can cripple your business or personal finances. Our experienced team provides strategic debt recovery solutions, from amicable settlements to aggressive legal action.
                        </p>
                        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            >
                                <div className="w-16 h-16 bg-[#E6D8B8] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaMoneyBillWave className="text-[#C85E4D] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Strategic Recovery</h3>
                                <p className="text-gray-600">We develop tailored strategies for each debt recovery case.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Negotiation First</h3>
                                <p className="text-gray-600">We prefer amicable settlements before legal action.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                <div className="w-16 h-16 bg-[#E6D8B8] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaChartLine className="text-[#C85E4D] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Legal Action</h3>
                                <p className="text-gray-600">When needed, we take decisive legal steps to recover debts.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaMoneyBillWave className="mr-2" /> Our Debt Recovery Services
                            </span>
                        </div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Practice Areas in Debt Recovery</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Comprehensive debt recovery solutions for this area.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A]">Why Choose Our Debt Recovery Team?</h2>
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your financial recovery deserves expert handling.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to your financial recovery, every step of the way.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-[#F9FAFB]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">We handle debt recovery cases in all major cities and districts.</p>
                    </motion.div>
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Remote debt recovery services available for cases in Gujarat.</p>
