...
import { FaBuilding, FaFileContract, FaBalanceScale, FaMapMarkedAlt, FaChartLine, FaQuestionCircle, FaPhoneAlt, FaWhatsapp, FaEnvelope, FaHandshake, FaRegPaperPlane, FaGlobe } from 'react-icons/fa';
import ServiceContactForm from '../components/ServiceContactForm';
const CorporateBusinessLaw = () => {
    ...
    const practiceAreas = [
        {
            ...
            items: [
                ...
                'LLP, partnership, and startup advisory',
        ...
        },
        {
            ...
            items: [
                'Drafting and vetting business contracts',
        ...
        },
        {
            ...
            items: [
                'NCLT and Company Law Board matters',
        ...
        },
        {
            ...
            items: [
                'FEMA, RBI, SEBI, and FDI compliance',
                'Legal opinions and compliance audits',
            ],
        },
    ];

    const reasonsToChoose = [
        'Extensive experience in corporate and commercial law',
        'End-to-end support for startups, SMEs, and large enterprises',
        'Expertise in regulatory compliance and risk management',
        'Strategic contract drafting and negotiation',
        'Proactive dispute resolution and litigation support',
        'Transparent, business-friendly approach',
    ];
    ...
    const processSteps = [
        ...
        'Share relevant documents and business details.',
        'We draft, review, or advise on your legal requirements.',
        'Ongoing support for compliance, contracts, and disputes.',
    ];

    const faqs = [
        {
            question: 'How do I register a new company in India?',
            answer: 'We guide you through the entire process, from choosing the right structure to filing with the ROC and post-incorporation compliance.',
        },
        {
            question: 'Can you help with contract disputes?',
            answer: 'Yes, we handle contract drafting, negotiation, and litigation for all types of business agreements.',
        },
        {
            question: 'What is NCLT and when do I need it?',
            answer: 'NCLT (National Company Law Tribunal) handles company law disputes, insolvency, and restructuring. We represent clients in all NCLT matters.',
        },
    ];
        ...
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                <div 
                    ...
                    style={{ 
                        backgroundImage: "url('https://images.unsplash.com/photo-1464983953574-0892a716854b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1500&q=80')",
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaBuilding className="mr-2" /> Corporate & Business Law
                            </span>
                        </div>
                        <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-8 leading-tight">
                            Corporate & Business Law <br/>
                            <span className="text-[#C85E4D]">Legal Solutions for Enterprises</span>
                        </h1>
                        <p className="text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Comprehensive legal support for businesses, startups, and corporates – from incorporation to dispute resolution.
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-4xl font-bold mb-8 text-gray-800">
                            Business Legal Solutions <span className="text-[#C85E4D]">Tailored for Your Success</span>
                        </h2>
                        <p className="text-xl text-gray-600 leading-relaxed">
                            From startup formation to complex corporate transactions, we provide comprehensive legal solutions that protect your business interests and drive growth.
                        </p>
                        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Business Formation</h3>
                                <p className="text-gray-600">Expert guidance in company incorporation and structuring.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                <div className="w-16 h-16 bg-[#F5F5F0] rounded-full flex items-center justify-center mx-auto mb-6">
                                    <FaFileContract className="text-[#1E3A8A] text-2xl" />
                                </div>
                                <h3 className="text-xl font-bold mb-4">Contract Management</h3>
                                <p className="text-gray-600">Strategic contract drafting and negotiation services.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Compliance & Risk</h3>
                                <p className="text-gray-600">Comprehensive regulatory compliance and risk management.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaBuilding className="mr-2" /> Our Corporate Services
                            </span>
                        </div>
                        <h2 className="text-4xl font-bold text-gray-800">Practice Areas in Corporate Law</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Comprehensive legal support for this aspect of corporate law.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-4xl font-bold text-[#1E3A8A]">Why Choose Our Corporate Law Team?</h2>
                        <p className="mt-4 text-lg text-gray-600">Your business deserves expert legal guidance.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to your business success, every step of the way.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-[#F9FAFB]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-lg text-gray-600">We serve businesses in all major cities and districts.</p>
                    </motion.div>
...
export default CorporateBusinessLaw; 