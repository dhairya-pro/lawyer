...
const CriminalLaw = () => {
    ...
    const reasonsToChoose = [
        "7+ Years of Criminal Courtroom Experience",
        "Expert in Gujarat Criminal Courts",
        "Strong Track Record in Bail Matters",
    ...
    const processSteps = [
        "Immediate consultation via phone or WhatsApp",
    ...
    const faqs = [
        {
            ...
            answer: "Contact us immediately. We'll guide you through the process and work on securing your release as soon as possible."
        },
        {
            question: "How quickly can you file for bail?",
            answer: "We can file for bail immediately after consultation. For urgent matters, we're available 24/7."
        },
        {
            question: "What documents do I need for consultation?",
            answer: "Bring any FIR, court notices, or relevant documents. If you don't have them, we can help obtain copies."
        }
    ];
    ...
    return (
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaBalanceScale className="mr-2" /> Expert Criminal Defense
                            </span>
                        </div>
                        ...
                        <p className="text-base sm:text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Trusted criminal defense representation across Gujarat's courts
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-base sm:text-xl text-gray-600 leading-relaxed">
                            Facing criminal charges can be overwhelming. With the right legal representation, you can protect your rights and build a strong defense. Advocate Jimit Ankur Thakore offers experienced criminal defense across Gujarat.
                        </p>
                        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-4">Expert Defense</h3>
                            ...
                            >
                                ...
                                <p className="text-gray-600">7+ years of courtroom experience in criminal cases.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                                className="bg-white p-8 rounded-xl shadow-lg border-t-4 border-[#1E3A8A]"
                            >
                                ...
                                <p className="text-gray-600">Round-the-clock legal assistance for emergencies.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Expert legal support for criminal matters.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your trusted partner in criminal defense.</p>
                    </motion.div>
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Comprehensive legal support for criminal matters across Gujarat.</p>
            ...
            <ServiceContactForm 
                title="Let's Talk"
                subtitle="Need help with criminal law matters? Contact us for expert legal guidance and support."
            />
        </div>
    );
};
