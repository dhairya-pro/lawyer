...
const LegalAdvisory = () => {
    ...
    const processSteps = [
        ...
        "Legal assessment & strategy development",
    ...
    const faqs = [
        {
            question: "What types of legal advisory services do you offer?",
            answer: "We offer comprehensive legal advisory services covering business, personal, and corporate matters, including contract drafting, compliance, risk assessment, and strategic legal guidance."
        },
        {
            question: "How do you ensure confidentiality in legal advisory?",
            answer: "We maintain strict confidentiality through secure communication channels, non-disclosure agreements, and professional ethics. Your information is always protected."
        },
        {
            question: "Do you provide ongoing legal support?",
            answer: "Yes, we offer continuous legal support and regular reviews to ensure your legal matters are always up-to-date and compliant with current regulations."
        }
    ];
    ...
    return (
        <div className="overflow-hidden bg-gradient-to-b from-gray-50 to-gray-100">
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-6 bg-[#C85E4D] text-white rounded-full">
                            <span className="flex items-center">
                                <FaGavel className="mr-2" /> Legal Advisory Expertise
                            </span>
                        </div>
                        ...
                        <p className="text-base sm:text-xl text-gray-200 max-w-2xl mx-auto mb-12">
                            Expert legal guidance and strategic solutions for your business and personal matters.
                        </p>
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
                    ...
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-gray-800">
                            Your legal matters need <span className="text-[#C85E4D]">expert guidance.</span>
                        </h2>
                        <p className="text-base sm:text-xl text-gray-600 leading-relaxed">
                            Our experienced team provides comprehensive legal advisory services, ensuring your interests are protected.
                        </p>
                        <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                            ...
                            >
                                ...
                                <p className="text-gray-600">We provide expert legal advice.</p>
                            </motion.div>
                            <motion.div 
                                whileHover={{ y: -10 }}
                            ...
                            >
                                ...
                                <p className="text-gray-600">We protect your legal interests.</p>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
                    ...
                    >
                        <div className="inline-block p-2 px-6 mb-4 bg-[#E6D8B8] text-gray-800 rounded-full">
                            <span className="flex items-center justify-center">
                                <FaGavel className="mr-2" /> Our Legal Advisory Services
                            </span>
                        </div>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Practice Areas in Legal Advisory</h2>
                    </motion.div>
                                ...
                                {practiceAreas[activeTab].items.map((item, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="ml-4">
                                            ...
                                            <p className="text-gray-600 mt-1">Comprehensive legal support for this advisory area.</p>
                                        </div>
                                    </motion.li>
                                ))}
                            </ul>
            ...
            <section className="py-24 bg-[#F5F5F0]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    <motion.div
                        ...
                        className="text-center mb-16"
                    >
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1E3A8A]">Why Choose Our Legal Advisory Team?</h2>
                        <p className="mt-4 text-base sm:text-lg text-gray-600">Your legal matters deserve expert guidance.</p>
                    </motion.div>
                            ...
                            >
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-700">
                                        We are committed to protecting your legal interests, every step of the way.
                                    </p>
                                </div>
                            </motion.div>
                        ))}
            ...
            <section className="py-24 bg-[#F9FAFB]">
                <div className="container mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    >
                        ...
                        <p className="mt-4 text-base sm:text-lg text-gray-600">We provide legal advisory services in all major cities and districts.</p>
                    </motion.div>
                        ...
                        <div className="lg:w-1/2 relative h-96 lg:h-auto">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl shadow-lg">
                                    ...
                                    <p className="text-gray-700 mb-4">Remote legal advisory available for clients in Gujarat.</p>
            ...
            <ServiceContactForm 
                title="Let's Talk"
                subtitle="Need legal advisory services? Contact us for expert guidance and support."
            />
        </div>
    );
};
