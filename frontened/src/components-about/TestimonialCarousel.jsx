...
const testimonials = [
  {
    ...
    name: "Joe barn",
    location: "Ahemedabad",
    text: "Exceptional Legal Support!\nI couldn't have asked for a better lawyer. [Lawyer's Name] guided me through a complex case with professionalism and care. Highly recommend!", // eslint-disable-line
    rating: 5,
  },
  {
    id: 2,
